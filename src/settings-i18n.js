...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      glassboxConfirmModeDesc: "When to ask before running actions the assistant proposes.",
      glassboxConfirmAlways: "Always",
      ...
      glassboxOrchModel: "Orchestrator model",
    ...
    zh: {
      ...
      glassboxConfirmModeDesc: "执行助手提议的操作前何时询问。",
      glassboxConfirmAlways: "每次确认",
    ...
    "zh-TW": {
      ...
      glassboxConfirmModeDesc: "執行助手提議的操作前何時詢問。",
      glassboxConfirmAlways: "每次確認",
    ...
    ko: {
      ...
      glassboxConfirmModeDesc: "어시스턴트가 제안한 작업을 실행하기 전 언제 물어볼지.",
      glassboxConfirmAlways: "항상",
    ...
    ja: {
      ...
      glassboxConfirmModeDesc: "アシスタントが提案した操作を実行する前にいつ確認するか。",
      glassboxConfirmAlways: "毎回確認",
      ...
      glassboxOrchModel: "オーケストレーターモデル",
